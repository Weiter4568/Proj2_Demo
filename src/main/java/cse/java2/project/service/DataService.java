...
//            System.out.println(test);
                ...
                // 指定输出文件路径
                String filePath = "/Users/weiter/Documents/SUSTech/2023Spring/CS209 Computer System Design & Application/Final Project/Final_Proj_Demo/questions/questions_";
                filePath += i;
                filePath += ".json";
                ...
                for (JsonElement questionElement : questionsArray) {
                    ...
                    int userID = 0;
                    if (! questionObject.getAsJsonObject("owner").get("user_type").getAsString().equals("does_not_exist")) {
...
//                System.out.println("--------------------------------------------");
    ...
    private void fetchAns(List<Question> questions){
        ...
        url += "/answers?order=desc&sort=votes&filter=withbody&site=stackoverflow&pagesize=100&key=JIOpBoY6dilGh0AY)KI*NA((&page=";
...
//            System.out.println(test);
                ...
                // 指定输出文件路径
                String filePath = "/Users/weiter/Documents/SUSTech/2023Spring/CS209 Computer System Design & Application/Final Project/Final_Proj_Demo/questions/answers_";
                filePath += ansNum;
                filePath += ".json";
                ...
                if (!jsonResponse.get("has_more").getAsBoolean())
                    break;
    ...
    private void fetchComment(List<Answer> answers){
        ...
        url += "/comments?order=desc&sort=votes&site=stackoverflow&pagesize=100&key=JIOpBoY6dilGh0AY)KI*NA((&page=";
...
//            System.out.println(test);
                ...
                // 指定输出文件路径
                String filePath = "/Users/weiter/Documents/SUSTech/2023Spring/CS209 Computer System Design & Application/Final Project/Final_Proj_Demo/questions/comments_";
                filePath += commentNum;
                filePath += ".json";
